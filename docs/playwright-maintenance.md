...
This document describes how to maintain Playwright integration in Foxyz.

## Overview

Foxyz integrates Playwright's browser automation capabilities through patches and additional files. These need to be kept in sync with upstream Playwright development.
