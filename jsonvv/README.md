...
This is a simple JSON schema validator library. It was created for Foxyz to validate passed user configurations. Because I found it useful for other projects, I decided to extract it into a separate library.
