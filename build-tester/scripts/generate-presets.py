"""
Generates per-context + global fingerprint configs using the Foxyz Python API.
Called by the foxyz-tester to get realistic fingerprint data.
...
from foxyz.fingerprints import generate_context_fingerprint
