        ...
        Column {
            ...
            T {
                ...
                text: dlgAct === "promptInstall"
                    ? "Foxyz " + dlgVer + "-" + dlgBuild + " is now active but not installed. Install it now?"
                    : (dlgAct === "install" ? "Install" : dlgAct === "uninstall" ? "Remove" : "Set") +
                      " Foxyz " + dlgVer + "-" + dlgBuild +
            ...
            StackLayout {
                    ...
                    ColumnLayout {
                        ...
                        Rectangle {
                            ...
                            ColumnLayout {
                                ...
                                T {
                                    Layout.alignment: Qt.AlignHCenter
                                    text: "Run: pip install foxyz[geoip]"
                                    color: c.muted
                ...
                Panel {
                    ...
                    GridLayout {
                        ...
                        Muted { text: "Website" }
                        T {
                            text: "<a href='https://foxyz.com' style='color:" + c.accent + "'>foxyz.com</a>"
                            textFormat: Text.RichText
