...
async def AsyncNewContext(
    ...
    **context_kwargs: Any,
    ...
    Parameters:
        browser: A Browser instance from AsyncNewBrowser or AsyncFoxyz.
    ...
    fp = await asyncio.get_event_loop().run_in_executor(
        None,
        lambda: generate_context_fingerprint(preset=preset, os=os, ff_version=ff_version, webrtc_ip=webrtc_ip, headless=headless),
    )
