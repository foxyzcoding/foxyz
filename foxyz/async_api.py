...
def _wrap_browser_with_init_scripts(browser: Any, font_list: Optional[List[str]] = None) -> Any:
    """
...
async def AsyncNewBrowser(
    ...
    **kwargs,
    ...
    if persistent_context:
        ...
        return _wrap_browser_with_init_scripts(result, font_list=_font_list)
